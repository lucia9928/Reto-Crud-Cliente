...
public class RestablecerContrasenaController {
    ...
    private void actualizarUsuario(Usuario usuario) {
        if (usuario instanceof Trabajador) {
            Trabajador traba = (Trabajador) usuario;
            TrabajadorFactoria.get().modificarTrabajador_XML(traba, traba.getDni());
        } else if (usuario instanceof Cliente) {
            Cliente cli = (Cliente) usuario;
            ClienteFactoria.get().modificarCliente_XML(cli, cli.getDni());
        }
    }
